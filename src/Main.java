...
public class Main extends JFrame implements KeyListener {
    ...
    public Main() {
        ...
        MainContent mainContent = new MainContent(STARTING_X,STARTING_Y,WINDOW_WIDTH, WINDOW_HEIGHT, spaceship,
                bulletList, eggList, title);
        ...
        switch (e.getKeyChar()) {
            case KeyEvent.VK_SPACE:
                if (!this.title.isVisible() || this.spaceship.getLife() != 0) {
                    Bullet bullet = new Bullet(this.spaceship.getHead().getX() + 15,
                            this.spaceship.getHead().getY(), true);
