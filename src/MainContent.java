...
public class MainContent extends JPanel {
    ...
    private static final int CHICKEN_ADDITION = 10;
    private static final int ROW_Y_ADDITION = 180;
    private static final int GAME_OVER_SPEED = 1;
                        ...
                        if(permissionToShoot == 10){
                            if(!title.isVisible()){
                                Bullet bullet = new Bullet(this.chickens[randomChickenRow][randomChicken].getX(),
                                        this.chickens[randomChickenRow][randomChicken].getY_ROW_1() + Chicken.HEIGHT +
                                                CHICKEN_ADDITION, false);
